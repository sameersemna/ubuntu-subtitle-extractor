# -*- coding: utf-8 -*-
"""
@Author  : Sameer Shemna
@Time    : 2021/3/24 9:28 上午
@FileName: exec.py
@desc: 主程序入口文件
python ./backend/exec.py --video '/home/sameer/Shared/Sync/Private/Test/Projects/nooruzuha/sunna3/3jPzfdiqWqE/3jPzfdiqWqE.mp4' --resolution '0,620,0,1280'
"""
import os
import random
import shutil
...
if __name__ == '__main__':
    ...
    video_path = '/home/sameer/Shared/Sync/Private/Test/Projects/nooruzuha/sunna3/FzGUIw0mVcc/FzGUIw0mVcc.mp4'
    # 提示用户输入字幕区域
    try:
        ...
        subtitle_area = (10, 630, 10, 1270)
    except ValueError as e:
        print(e)
        subtitle_area = None

    print(f"Running for {video_path} ||| {subtitle_area}")
    # 新建字幕提取对象
